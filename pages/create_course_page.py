...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_description_textarea = page.get_by_test_id('create-course-form-description-input').locator('textarea')
        ...
        self.create_course_excercises_title = page.get_by_test_id('create-course-exercises-box-toolbar-title-text')
        self.create_course_excescises_button = page.get_by_test_id('create-course-exercises-box-toolbar-create-exercise-button')
        
        # Блок, который отображется, когда в курсе нет заданий
        self.create_course_excercises_empty_view_icon = page.get_by_test_id('create-course-exercises-empty-view-icon')
        self.create_course_excercises_empty_view_title = page.get_by_test_id('create-course-exercises-empty-view-title-text')
        self.create_course_excercises_empty_view_description = page.get_by_test_id('create-course-exercises-empty-view-description-text')

        # Пока не пригодилось
        # self.excercise_number = page.get_by_test_id('create-course-exercise-0-box-toolbar-subtitle-text')
        # self.excercise_title_input = page.get_by_test_id('create-course-exercise-form-title-0-input').locator('input')
        # self.excercise_description_input = page.get_by_test_id('create-course-exercise-form-description-0-input').locator('input')
        # self.excercise_delete_button = page.get_by_test_id('create-course-exercise-0-box-toolbar-delete-exercise-button')
    ...
    def check_visible_exercises_title(self):
        expect(self.create_course_excercises_title).to_be_visible()
        expect(self.create_course_excercises_title).to_have_text('Exercises')

    def check_visible_create_exercise_button(self):
        expect(self.create_course_excescises_button).to_be_visible()

    def click_create_exercise_button(self):
        self.create_course_excescises_button.click()

    def check_visible_exercises_empty_view(self):
        expect(self.create_course_excercises_empty_view_icon).to_be_visible()

        expect(self.create_course_excercises_empty_view_title).to_be_visible()
        expect(self.create_course_excercises_empty_view_title).to_have_text('There is no exercises')
    ...
    def check_visible_create_exercise_form(self, index: int, title:str, description:str):
        ...
        expect(excescise_subtitle).to_be_visible()
        expect(excescise_subtitle).to_have_text(f"#{index + 1} Exercise")
